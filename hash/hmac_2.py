...
#Now Eve intercepts and modify the message

m_alice = modify_message(m_alice)

#Bob validates:

sha256_bob2 = hashlib.sha256()
sha256_bob2.update(secret_key_bob)
sha256_bob2.update(m_alice)
hmac_bob2 = sha256_bob2.digest()
print("Message:", m_alice, ", hmac_bob2 :", hmac_bob2)